...
public class BundleSaveStateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bundle_save_state);
        ...
        incrementButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BundleSaveStateActivity.this,
                        "Try rotating the screen to see this number persist.",
     ...
     *
     * @param savedInstanceState a Bundle containing the data that was saved during the previous
